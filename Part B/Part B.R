...
# female
inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived)) -
  inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived))
...
# c_con15 
inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*(mean(e$c_con15) + 1) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived)) - 
  inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived))
  
# c_ukip15
inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*(mean(e$c_ukip15) + 1) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived)) -
  inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived))

# c_unemployed
inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*(mean(e$c_unemployed) + 1) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived)) -
  inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived))
...
# c_deprived 
inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*(mean(e$c_deprived) + 1)) -
  inv.logit(fixef(m1)[1] + fixef(m1)[2] + fixef(m1)[3] + fixef(m1)[4] + fixef(m1)[5] + fixef(m1)[6] + fixef(m1)[7] + fixef(m1)[8]*mean(e$c_con15) + fixef(m1)[9]*mean(e$c_ukip15) + fixef(m1)[10]*mean(e$c_unemployed) + fixef(m1)[11]*mean(e$c_whitebritish) + fixef(m1)[12]*mean(e$c_deprived))
